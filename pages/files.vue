...
<template>
  <div class="text-white bg-black font-extrabold text-4xl text-center p-4">
    Upload Model File
  </div>
  ...
  <div class="my-4">
    <label for="upload" class="flex flex-col items-center gap-2 cursor-pointer">
      ...
      <span class="text-gray-600 font-medium">Select File ↑</span>
    </label>
    ...
    <div class="flex flex-col items-center justify-center">
      ...
      >
        ...
        >
          {{ file?.name || "No file to upload" }}
        </li>
      </ul>

      <button class="bg-blue-500 text-white px-4 py-2 rounded" @click="submit">
        Upload
      </button>
    </div>
